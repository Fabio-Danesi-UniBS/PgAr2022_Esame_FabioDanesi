...
public class CodiceFiscale {
	...
	/**
	 * è un costruttore di codice fiscale con parametro un codice fiscale(letto da codiciFiscali.xml) e controlla la sua validità
	 */
	...
	/**
	 * è l'inizializzatore di tutti i metodi di codice fiscale
	 */
	...
	/**
	 * controlla la validità di un cognome passata in ingresso
	 */
	...
	/**
	 * controlla che l'anno passato come parametro sia bisestile e setta febbraio
	 */
	public void bisestile(String anno) {
	 ...
	 /**
	  * controlla che il carattere controllo sia un carattere alfabetico
	  */
	...
	/**
	 * controlla se il luogo è corretto in base all'ArrayList comuni
	 */
	...
	/**
	 * controlla che il giorno sia un numero corretto in base al mese
	 */
	...
	/**
	 * controlla che l'anno sia un numero corretto e  richiama il metodo bisestile 
	 */
