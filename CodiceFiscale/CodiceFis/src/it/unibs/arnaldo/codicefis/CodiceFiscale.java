...
public class CodiceFiscale {
	...
	public boolean takeAControl(ArrayList<Comune> controlloComune) {
		if(toString().length()==16) {
			//FORSE:devo usare il codice di controllo a rovescio per ricavare la data esatta da passare a anno, mese, giorno!
	...
	public static boolean controlloLuogo(String luogo, ArrayList<Comune> comuni) {
		/*char a;
		int b;
		boolean ok=false;
		a=luogo.charAt(0);
